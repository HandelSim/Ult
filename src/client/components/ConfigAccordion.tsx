    ...
    <div className="space-y-2">
      ...
      <AccordionSection title="Model & Execution" defaultOpen>
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1">Escalation Policy</label>
              <select
      ...
      <AccordionSection title="Acceptance Criteria">
        <textarea
          ...
          rows={4}
          className="w-full text-sm border border-gray-300 rounded px-2 py-1.5 font-mono focus:outline-none focus:ring-1 focus:ring-blue-500 resize-y disabled:bg-gray-50"
        />
      </AccordionSection>
      ...
      <AccordionSection title="File Boundaries" count={node.allowed_paths.length}>
        <div className="space-y-2">
          <p className="text-xs text-gray-500">One path per line. Agent can only read/write these paths.</p>
          <textarea
      ...
      <AccordionSection title="Allowed Tools" count={node.allowed_tools.length}>
        <div className="space-y-2">
          <p className="text-xs text-gray-500">One tool per line.</p>
          <textarea
      ...
      <AccordionSection title="Dependencies" count={node.dependencies.length}>
        <div className="space-y-2">
          <p className="text-xs text-gray-500">Sibling node names this node depends on (one per line).</p>
          <textarea
      ...
      <AccordionSection title="Hooks (JSON)">
        <div className="space-y-2">
          ...
          <textarea
            ...
            readOnly={readOnly}
            rows={6}
            className="w-full text-xs border border-gray-300 rounded px-2 py-1.5 font-mono focus:outline-none focus:ring-1 focus:ring-blue-500 resize-y disabled:bg-gray-50"
          />
        </div>
      </AccordionSection>
      ...
      <AccordionSection title="MCP Tools" count={node.mcp_tools.length}>
        <div className="space-y-2">
          <p className="text-xs text-gray-500">MCP server configurations in JSON array format.</p>
          <textarea
      ...
      <AccordionSection title="Context Files" count={node.context_files.length}>
        <div className="space-y-2">
          <p className="text-xs text-gray-500">Files copied into workspace for reference (one per line).</p>
          <textarea
